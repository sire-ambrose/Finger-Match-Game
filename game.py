...
class pickNum(Screen):
    def __init__(self, **kwargs):
        ...
        self.mbox.add_widget(Label(text='Pick Your Number', size=(100,100)))
    ...
    def gotofirst10(self,instance):
        plnum=open("plnum.txt", "w")
        plnum.write('10')
        plnum.close()
        self.pnum=open("plnum.txt", "r")
        #r.remove_widget(welcome())
        r.add_widget(game())
        self.manager.current='game'
...
class welcome(Screen):
    def __init__(self, **kwargs):
        ...
        self.add_widget(self.gd)
        #self.gd.add_widget(Label(text=rd))
        self.gd.add_widget(Button(text="Play", on_press=self.gopickNum, pos_hint={'x':0.5,'y':0.5},size_hint=(0.1,0.1)))
        #self.gd.add_widget(Button(text="View Previous", on_press=self.previous))
    def gopickNum(self,instance):
...
class game(Screen):  
    ...
    def __init__(self, **kwargs):
        ...
        self.pnum=int(open("plnum.txt", 'r').read())

        #computer finger grid
